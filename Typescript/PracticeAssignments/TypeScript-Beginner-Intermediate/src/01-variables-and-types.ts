...
const me: User = { name: "Aryan", age: 20, isActive: true, accountBalance: 1000 }

function userProfile(person: User): User {
    var profileName: string = person.name;
    let profileAge: number = person.age;
    const profileStatus: boolean = person.isActive;
    var profileBalance: number = person.accountBalance;
